...
### [⬇️ Baixar o aplicador para Windows (ZIP)](https://github.com/Hieronymouss/mgs1-ptbr-patcher/releases/download/v0.1.0-beta.4/MGS1-PTBR-Patcher-0.1.0-beta.4-win-x64.zip)
...
[SHA-256 publicado](https://github.com/Hieronymouss/mgs1-ptbr-patcher/releases/tag/v0.1.0-beta.4).
